...
import z5xconsulting.z5x.com.z5xconsulting.models.User;
import z5xconsulting.z5x.com.z5xconsulting.utility.FilePaths;
...
//specify where the photo will be stored
        ...
        if(mBytes.length/MB < MB_THRESHHOLD) {
            ...
            StorageMetadata metadata = new StorageMetadata.Builder()
                     ...
                     */
                    .setCustomMetadata("Rom's special meta data", "JK nothing special here")
    ...
    private void getUserAccountsData(){
        ...
        /*
            --------- Query method 2 ----------
         */
        //Query on the field user_id instead of the key
